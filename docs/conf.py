...
htmlhelp_basename = 'invenio-assets_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-assets.tex', u'invenio-assets Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-assets', u'invenio-assets Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-assets', u'Invenio-Assets Documentation',
   author, 'invenio-assets', 'Media assets management for Invenio.',
   'Miscellaneous'),
]
